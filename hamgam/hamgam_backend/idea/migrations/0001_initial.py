    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(related_name='idea_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('idea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commments_idea', to='idea.idea')),
            ],
            options={
                'abstract': False,
            },
